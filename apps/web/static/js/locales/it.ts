...
export const it = {
  ...
  "sources.roster": "Elenco piscine",
  "sources.schedules": "Orari di apertura",
  "sources.lanePlans": "Piani delle corsie",
  "sources.pdf": "PDF",
  ...
  "place.fixedAgo": "rilevata {age} fa",
  ...
  "glance.water.stale": "Acqua, prima",
  "glance.water.nominal": "Acqua, dichiarata",
  "glance.length": "Lunghezza",
  "glance.lanes": "Corsie",
  ...
  "meta.builtAt": "Aggiornato il",
  "meta.check.upToDate": "Dati aggiornati",
  "meta.check.updated": "Dati più recenti installati",
  "meta.check.couldNotCheck": "Impossibile verificare i dati più recenti",
  "meta.check.appUpdateNeeded": "Aggiorna l’app per dati più recenti",
  "meta.staleSource": "{source}: non aggiornato dal {date}",
  "meta.offlineNote.pull":
    "Funziona offline. Trascina verso il basso per cercare dati più recenti.",
  "nav.about": "Informazioni su SwimZH",
  "about.title": "Informazioni",
  "about.version": "Versione {version} ({build})",
  "about.data": "Dati delle piscine",
  "about.poolCount": {
    one: "{count} piscina a Zurigo",
    many: "{count} piscine a Zurigo",
    other: "{count} piscine a Zurigo",
  },
  "about.source.fresh": "scaricato il {date}",
  "about.source.stale": "conservato dal {date} — il sito non era raggiungibile",
  "about.checkNow": "Cerca dati più recenti",
  "about.checking": "Verifica in corso…",
  "about.dataNote":
    "Ogni orario, prezzo e piano delle corsie viene dalle pagine della città e viene ricostruito circa una volta alla settimana.",
  "about.madeBy": "Realizzato da",
  "about.contribute": "Contribuisci",
  "about.repository": "Codice sorgente su GitHub",
  "about.issues": "Segnala un problema",
  "about.dataSource": "Pagine delle piscine della Città di Zurigo",
  "about.contributeNote":
    "SwimZH è open source. Correzioni, piscine mancanti e traduzioni migliori sono benvenute.",
  ...
  "action.forward": "Avanti",
  "action.reload": "Ricarica",
  "action.openInSafari": "Apri in Safari",
