...
export const en = {
  ...
  "sources.roster": "Pool list",
  "sources.schedules": "Opening hours",
  "sources.lanePlans": "Lane plans",
  "sources.pdf": "PDF",
  ...
  "meta.builtAt": "Updated",
  "meta.check.upToDate": "Up to date",
  "meta.check.updated": "Newer data installed",
  "meta.check.couldNotCheck": "Could not check for newer data",
  "meta.check.appUpdateNeeded": "Update the app for newer data",
  "meta.staleSource": "{source}: not refreshed since {date}",
  "meta.offlineNote.pull": "Works offline. Pull down to check for newer data.",
  "nav.about": "About SwimZH",
  "about.title": "About",
  "about.version": "Version {version} ({build})",
  "about.data": "Pool data",
  "about.poolCount": {
    one: "{count} pool in Zürich",
    other: "{count} pools in Zürich",
  },
  "about.source.fresh": "fetched {date}",
  "about.source.stale": "kept from {date} — the site could not be reached",
  "about.checkNow": "Check for newer data",
  "about.checking": "Checking…",
  "about.dataNote":
    "Every opening hour, price and lane plan comes from the city’s own pages and is rebuilt about once a week.",
  "about.madeBy": "Made by",
  "about.contribute": "Contribute",
  "about.repository": "Source code on GitHub",
  "about.issues": "Report a problem",
  "about.dataSource": "Pool pages of the City of Zürich",
  "about.contributeNote":
    "SwimZH is open source. Corrections, missing pools and better translations are welcome.",
  ...
  "action.openInSafari": "Open in Safari",
