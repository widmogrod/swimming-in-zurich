...
export const pl = {
  ...
  "sources.roster": "Lista basenów",
  "sources.schedules": "Godziny otwarcia",
  "sources.lanePlans": "Plany torów",
  "sources.pdf": "PDF",
  ...
  "glance.water.stale": "Woda, wcześniej",
  "glance.water.nominal": "Woda, deklarowana",
  "glance.length": "Długość",
  "glance.lanes": "Tory",
  ...
  "meta.builtAt": "Zaktualizowano",
  "meta.check.upToDate": "Dane aktualne",
  "meta.check.updated": "Zainstalowano nowsze dane",
  "meta.check.couldNotCheck": "Nie udało się sprawdzić nowszych danych",
  "meta.check.appUpdateNeeded":
    "Zaktualizuj aplikację, aby otrzymać nowsze dane",
  "meta.staleSource": "{source}: nieodświeżane od {date}",
  "meta.offlineNote.pull":
    "Działa offline. Pociągnij w dół, aby sprawdzić nowsze dane.",
  "nav.about": "O SwimZH",
  "about.title": "O aplikacji",
  "about.version": "Wersja {version} ({build})",
  "about.data": "Dane basenów",
  "about.poolCount": {
    one: "{count} basen w Zurychu",
    few: "{count} baseny w Zurychu",
    many: "{count} basenów w Zurychu",
    other: "{count} basena w Zurychu",
  },
  "about.source.fresh": "pobrano {date}",
  "about.source.stale": "zachowano z {date} — strona była niedostępna",
  "about.checkNow": "Sprawdź nowsze dane",
  "about.checking": "Sprawdzanie…",
  "about.dataNote":
    "Każda godzina otwarcia, cena i plan torów pochodzi ze stron miasta i jest odbudowywana mniej więcej co tydzień.",
  "about.madeBy": "Autor",
  "about.contribute": "Współtwórz",
  "about.repository": "Kod źródłowy na GitHubie",
  "about.issues": "Zgłoś problem",
  "about.dataSource": "Strony basenów miasta Zurych",
  "about.contributeNote":
    "SwimZH jest open source. Poprawki, brakujące baseny i lepsze tłumaczenia są mile widziane.",
  ...
  "action.done": "Gotowe",
  "action.back": "Wstecz",
  "action.forward": "Dalej",
  "action.reload": "Odśwież",
  "action.openInSafari": "Otwórz w Safari",
