...
export const de = {
  ...
  "sources.roster": "Bäderliste",
  "sources.schedules": "Öffnungszeiten",
  "sources.lanePlans": "Belegungspläne",
  "sources.pdf": "PDF",
  ...
  "glance.water.stale": "Wasser, früher",
  "glance.water.nominal": "Wasser, laut Bad",
  "glance.length": "Länge",
  "glance.lanes": "Bahnen",
  ...
  "meta.builtAt": "Aktualisiert am",
  "meta.check.upToDate": "Auf dem neuesten Stand",
  "meta.check.updated": "Neuere Daten installiert",
  "meta.check.couldNotCheck": "Neuere Daten konnten nicht geprüft werden",
  "meta.check.appUpdateNeeded": "App aktualisieren für neuere Daten",
  "meta.staleSource": "{source}: seit {date} nicht aktualisiert",
  "meta.offlineNote.pull":
    "Funktioniert offline. Nach unten ziehen, um nach neueren Daten zu suchen.",
  "nav.about": "Über SwimZH",
  "about.title": "Über",
  "about.version": "Version {version} ({build})",
  "about.data": "Bäderdaten",
  "about.poolCount": {
    one: "{count} Bad in Zürich",
    other: "{count} Bäder in Zürich",
  },
  "about.source.fresh": "abgerufen am {date}",
  "about.source.stale": "Stand {date} — die Seite war nicht erreichbar",
  "about.checkNow": "Nach neueren Daten suchen",
  "about.checking": "Wird geprüft …",
  "about.dataNote":
    "Jede Öffnungszeit, jeder Preis und jeder Belegungsplan stammt von den Seiten der Stadt und wird etwa wöchentlich neu aufgebaut.",
  "about.madeBy": "Gemacht von",
  "about.contribute": "Mitmachen",
  "about.repository": "Quellcode auf GitHub",
  "about.issues": "Ein Problem melden",
  "about.dataSource": "Bäderseiten der Stadt Zürich",
  "about.contributeNote":
    "SwimZH ist Open Source. Korrekturen, fehlende Bäder und bessere Übersetzungen sind willkommen.",
  ...
  "action.openInSafari": "In Safari öffnen",
